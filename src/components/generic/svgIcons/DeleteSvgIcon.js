...
/**
 * Generic delete svg icon
 */
import React, { Component } from 'react';

export default class DeleteSvgIcon extends Component {
  static propTypes = {
  ...
  render () {
    ...
    return (
      <svg
        ...
        style={{enableBackground: 'new 0 0 18.588 18.588'}}
        xmlSpace='preserve'
        width={`${width}px`}
        height={`${width}px`}
        fill={color}>
        <path d='M13.849,3.414L12.816,0.2l-1.147,1.021L9.287,0L9.179,1.856L8.163,0.839L5.272,3.414H2.054v2.631
